 ...
 */
define(['N/https', 'N/record', 'N/email', 'N/search'], function(https, record, email, search) {
    ...
    function postFunction(context) {
        ...
        var emailString = 'First NameL {{firstname}}\nLast Name: {{lastname}}\nEmail: {{email}}\nFacebook URL: {{custentity_fb_url}}';
        ...
        if (params["project"] && params["project"] !== "" && params["project"] != null && params["project"] !== "{{projectid}}") {
            var lkpfld = search.lookupFields({
                type : 'job',
                id : params["project"],
                columns : ["companyname"]
